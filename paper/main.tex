...
\begin{enumerate}
  ...
  $6\times10^{-7}$ relative difference in every case ($k=23$ agrees to
  within $5\times10^{-10}$ relative difference specifically).
  \item \textbf{Growth-ratio consistency.} $a(k)/a(k-1)$ for
  $k=19,\dots,23$ is $9.4699, 9.4966, 9.5208, 9.5427, 9.5627$
  respectively --- a smooth, monotonically increasing sequence
