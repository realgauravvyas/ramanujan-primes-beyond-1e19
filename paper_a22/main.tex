...
This paper reports a certified extension of $a(k)$ to $k=20,21,22$.
...
\caption{$a(k)$ for $k=1,\dots,22$. Times for $k \leq 18$ and $k=21,22$
...
Every new term reported here (\(k=18\)--\(22\)) passes
...
A181671 to $k=20,21,22$, computed entirely on
